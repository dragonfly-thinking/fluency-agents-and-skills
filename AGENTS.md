...
**You are an AI coding agent (Claude Code or Codex). The user has asked you to set up this kit. Follow the steps for the user's runtime below.** This installs 6 specialist subagents and 12 skills into the user's environment so they're available in every session, not just this folder.
...
- **12 skills** (verbs the user invokes): `proofread`, `critical-review`, `research-brief`, `discovery-interview`, `premortem`, `weekly-review`, `daily-brief`, `visual-explainer`, `slides`, `canvas-design`, `pdf-create`, `here-now`
...
> "Installed 6 agents and 12 skills. Try: *proofread `after-automation.md`*, *run a premortem on this plan*, *build me slides on X*, or *publish this with here-now*."
